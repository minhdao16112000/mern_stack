...
import { ADD_CART, DECREASE_QUANTITY, DELETE_CART, DELETE_ALL_CART, GET_NUMBER_CART, INCREASE_QUANTITY } from "../../constants/cartConstant";

const cartReducer = (state = _state.cartState, action) => {
    switch (action.type) {
        ...
        case INCREASE_QUANTITY:
            if (state.carts[action.payload].quantity < state.carts[action.payload].inStock) {
