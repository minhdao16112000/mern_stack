...
const Content = () => {
    ...
    if (listOrders && listOrders.Orders) {
        orderYear = listOrders.Orders.filter(
            (value) =>
                Number(value.createdAt.substring(0, 4)) === moment().year()
        );
    }
    var orderMonth = orderYear.filter(
        (value) =>
            Number(value.createdAt.substring(5, 7)) === today.getMonth() + 1
    );
    var orderLastMonth = orderYear.filter(
        (value) => Number(value.createdAt.substring(5, 7)) === today.getMonth()
    );
            ...
            return (
                <>
                    ...
                    {after > before ? (
                        ...
                        <p className="text-sm">{percent(before, after)}</p>
                    ) : (
                        <p className="text-sm text-danger">
                            {percent(before, after)}
                            <span className="text-gray"> Giảm</span>
                        </p>
                    )}
                </>
            );
    ...
    const percent = (before, after) => {
        if (before > after) {
            ...
            if (before === 0) {
                return (
                    <>
                        <i className="lni lni-arrow-up" /> +{(100.0).toFixed(2)}
                        %
                    </>
                );
            } else {
                    ...
                    <div className="row align-items-center">
                        <div className="col-md-6">
                            <div className="title mb-30">
                                <h2>Trang Quản Trị Cửa Hàng Fashi</h2>
                            </div>
                        </div>
                        {/* end col */}
                        {/* <div className="col-md-6">
                ...
                <div className="row">
                    <div className="col-xl-6 col-lg-4 col-sm-6">
                        <div className="icon-card mb-30">
                            ...
                            <div className="content">
                                <h6 className="mb-10">Các Đơn Hàng Mới</h6>
                                <h3 className="text-bold mb-10">
                    ...
                    <div className="col-xl-6 col-lg-4 col-sm-6">
                        <div className="icon-card mb-30">
                            ...
                            <div className="content">
                                <h6 className="mb-10">Tổng Doanh Thu</h6>
                                {TotalIncome()}
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="left">
                                    ...
                                    <h3 className="text-bold">
                                        ...
                                        {reqOptionPrice === 0
                                            ...
                                            : reqOptionPrice === 1
                                            ? (TotalMonthly() / 25000).toFixed(
                                                  2
                                              )
                                            : (TotalWeekly() / 25000).toFixed(
                                                  2
                                              )}
                                    </h3>
                                </div>
